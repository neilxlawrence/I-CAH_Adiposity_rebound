...
load_ar_files_function(previous_file_name = "file_5",
...
#17OHP nmol/l or maybe ng/ml

#androstenedione nmol/l or maybe ng/ml

#renin µIU/ml or maybe ng/l

#plasma renin activity nmol/l/hr or maybe ng/ml/hr

#the first of those would be the more british, so let's convert to that
...
#this is also referenced in the paper https://www.sciencedirect.com/science/article/pii/S0735109710008661#:~:text=The%20conversion%20factor%20for%20PRC,pg%2Fml%20in%20supine%20position.
...
#this reference quotes 7.6: https://wardelab.com/warde-reports/test-update-renin-and-aldosterone-renin-ratio/#:~:text=There%20is%20no%20precise%20conversion,(range%205.5%20to%209.7).
...
ghent <- subset(long_17OHP_to_impute_units_missing_only, labs_centre_name=="Ghent")
...
#       donors = 5, 
#       incluster = TRUE,
       seed = 500) # increasing the donors has allowed the lesser category to be selected, but its no longer abiding perfectly by the hierarchy
...
for (each_centre in unique(unit_imputations_17OHP_wide$centre_name)) {
  ...
  grid_plot <-
    grid.arrange(overall_17OHP_units_plot, centre_specific_17OHP_plot, frequency_bar_plot, ncol=1)
