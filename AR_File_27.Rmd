...
```{r, extract only those with bmi and separate by sex}
ar_data_both_sexes_with_bmi_using_interpolations <-
  subset(ar_data, !is.na(bmi_using_interpolations))

ar_data_male_with_bmi_using_interpolations <-
  subset(ar_data, 
         !is.na(bmi_using_interpolations) &
         sex_1_for_M_2_for_F==1)

ar_data_fema_with_bmi_using_interpolations <-
  subset(ar_data, 
         !is.na(bmi_using_interpolations) &
...
degrees_of_freedom_values <- 3  
df <- 3
minimum_age_to_use_values <- 0.2  # Example range
min_age <- 0.2
maximum_age_to_use_values <- 7  # Example range
max_age <- 7
minimum_number_of_visits <- 6
min_visits <- 6
this_file_variable <- "bmi_using_interpolations"
```
...
```{r, create attrition frame for each combination of minimum and maximum ages and numbers of visits}
for(each_group in c(
  "both_sexes",
  "male",
  "fema"
...
```{r, both_sexes fit the sitar model for bmi using different restrictions on age df and number of visits}
...
###################  
  ...
  if (nrow(ar_data_both_sexes_restricted) == 0) {
    ...
    list_of_both_sexes_fitting_results_bmi[[]] <- 
      "No data"
        next
      }
  ...
  list_of_both_sexes_sitar_models_bmi[[name_of_model_restrictions]] <- 
      sitar_model_fit

  # Extract fixed effects
  fixed_effects_fit_data_frame_bmi <- 
    data.frame(ln_post_conceptual_age = seq(-0.3, 3.05, by = 0.01))
  
  #back calculate age
  fixed_effects_fit_data_frame_bmi$age <-
    exp(fixed_effects_fit_data_frame_bmi$ln_post_conceptual_age) - 0.75
  
  #predict fixed effects using a level of zero
  fixed_effects_fit_data_frame_bmi$bmi <- 
    as.numeric(predict(sitar_model_fit, newdata = fixed_effects_fit_data_frame_bmi, level = 0))
  
  #use our function to pull out the adiposity rebound
  fixed_effects_adiposity_metrics <-
  find_first_peak_trough(
      df=fixed_effects_fit_data_frame_bmi,
      value_col="bmi",
      age_col="age"
  )
  #put those adiposity metrics within the fixed effects fit frame just for ease of adding to a plot
  fixed_effects_fit_data_frame_bmi <- 
    cbind(fixed_effects_fit_data_frame_bmi, fixed_effects_adiposity_metrics)
  
  # Store fixed effects
  list_of_both_sexes_overall_fixed_effects_bmi[[name_of_model_restrictions]] <- 
      fixed_effects_fit_data_frame_bmi
  ...
  list_of_both_sexes_random_effects_bmi[[name_of_model_restrictions]] <- 
      sitar_model_random_effects
  ...
  individual_patient_random_effects_for_curves_bmi <- data.frame()
  ...
  for (each_id in unique(ar_data_both_sexes_restricted$id)){
    ...
    individual_patient_random_effects_for_curves_bmi <- 
      rbind(individual_patient_random_effects_for_curves_bmi, single_person_frame)
      
  }
  
  #store the large frame with random effects predictions for curves
  list_of_both_sexes_individual_patient_random_effects_for_curves_bmi[[name_of_model_restrictions]] <- 
      individual_patient_random_effects_for_curves_bmi
  ...
  ar_data_both_sexes_restricted_random_effect_predictions$sitar_prediction_bmi <-
    predict(
      sitar_model_fit, 
  ...
  list_of_both_sexes_patient_data_with_sitar_predictions_bmi[[name_of_model_restrictions]] <- 
      ar_data_both_sexes_restricted_random_effect_predictions
...
list_of_both_sexes_fitting_results_bmi[[name_of_model_restrictions]] <- 
    fit_status
...
if (!is.null(error_msg)) {
  print(fit_status)
  print(error_msg)
  list_of_both_sexes_error_messages_bmi[[name_of_model_restrictions]] <- 
      error_msg
}

#save the lists each time so we can review them and mess with them on another computer
save(list_of_both_sexes_sitar_models_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_sitar_models_bmi.Rdata"))
save(list_of_both_sexes_overall_fixed_effects_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_overall_fixed_effects_bmi.Rdata"))
save(list_of_both_sexes_random_effects_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_random_effects_bmi.Rdata"))
save(list_of_both_sexes_patient_data_with_sitar_predictions_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_patient_data_with_sitar_predictions_bmi.Rdata"))
save(list_of_both_sexes_individual_patient_random_effects_for_curves_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_individual_patient_random_effects_for_curves_bmi.Rdata"))
save(list_of_both_sexes_fitting_results_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_fitting_results_bmi.Rdata"))
save(list_of_both_sexes_error_messages_bmi,   
     file = paste0("ar_data_files_to_load/list_of_both_sexes_error_messages_bmi.Rdata"))
...
```{r, male fit the sitar model for bmi using different restrictions on age df and number of visits}
...
###################  
  ...
  if (nrow(ar_data_male_restricted) == 0) {
    cat("Skipping: No data left after filtering.\n")
    list_of_male_fitting_results_bmi[[]] <- 
      "No data"
        next
      }
  ...
  # Store the successfully fitted model
  list_of_male_sitar_models_bmi[[name_of_model_restrictions]] <- 
      sitar_model_fit
  ...
  # Store fixed effects
  list_of_male_overall_fixed_effects_bmi[[name_of_model_restrictions]] <- 
      fixed_effects_fit_data_frame_bmi
  ...
  # Store random effects
  list_of_male_random_effects_bmi[[name_of_model_restrictions]] <- 
      sitar_model_random_effects
  ...
  #store the large frame with random effects predictions for curves
  list_of_male_individual_patient_random_effects_for_curves_bmi[[name_of_model_restrictions]] <- 
      individual_patient_random_effects_for_curves_bmi
  ...
  #add the sitar individual patient level predictions by patient
  ar_data_male_restricted_random_effect_predictions$sitar_prediction_bmi <-
    predict(
      sitar_model_fit, 
  ...
  #store the original data and predictions outside of the loop
  list_of_male_patient_data_with_sitar_predictions_bmi[[name_of_model_restrictions]] <- 
      ar_data_male_restricted_random_effect_predictions
...
#store whether the model failed or succeeded  
list_of_male_fitting_results_bmi[[name_of_model_restrictions]] <- 
    fit_status
...
if (!is.null(error_msg)) {
  print(fit_status)
  print(error_msg)
  list_of_male_error_messages_bmi[[name_of_model_restrictions]] <- 
      error_msg
}

#save the lists each time so we can review them and mess with them on another computer
save(list_of_male_sitar_models_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_sitar_models_bmi.Rdata"))
save(list_of_male_overall_fixed_effects_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_overall_fixed_effects_bmi.Rdata"))
save(list_of_male_random_effects_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_random_effects_bmi.Rdata"))
save(list_of_male_patient_data_with_sitar_predictions_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_patient_data_with_sitar_predictions_bmi.Rdata"))
save(list_of_male_individual_patient_random_effects_for_curves_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_individual_patient_random_effects_for_curves_bmi.Rdata"))
save(list_of_male_fitting_results_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_fitting_results_bmi.Rdata"))
save(list_of_male_error_messages_bmi,   
     file = paste0("ar_data_files_to_load/list_of_male_error_messages_bmi.Rdata"))
...
```{r, fema fit the sitar model for bmi using different restrictions on age df and number of visits}
...
###################  
  ...
  if (nrow(ar_data_fema_restricted) == 0) {
    cat("Skipping: No data left after filtering.\n")
    list_of_fema_fitting_results_bmi[[]] <- 
      "No data"
        next
      }
  ...
  # Store the successfully fitted model
  list_of_fema_sitar_models_bmi[[name_of_model_restrictions]] <- 
      sitar_model_fit
  ...
  # Store fixed effects
  list_of_fema_overall_fixed_effects_bmi[[name_of_model_restrictions]] <- 
      fixed_effects_fit_data_frame_bmi
  ...
  # Store random effects
  list_of_fema_random_effects_bmi[[name_of_model_restrictions]] <- 
      sitar_model_random_effects
  ...
  #store the large frame with random effects predictions for curves
  list_of_fema_individual_patient_random_effects_for_curves_bmi[[name_of_model_restrictions]] <- 
      individual_patient_random_effects_for_curves_bmi
  ...
  #add the sitar individual patient level predictions by patient
  ar_data_fema_restricted_random_effect_predictions$sitar_prediction_bmi <-
    predict(
      sitar_model_fit, 
  ...
  #store the original data and predictions outside of the loop
  list_of_fema_patient_data_with_sitar_predictions_bmi[[name_of_model_restrictions]] <- 
      ar_data_fema_restricted_random_effect_predictions
...
#store whether the model failed or succeeded  
list_of_fema_fitting_results_bmi[[name_of_model_restrictions]] <- 
    fit_status
...
if (!is.null(error_msg)) {
  print(fit_status)
  print(error_msg)
  list_of_fema_error_messages_bmi[[name_of_model_restrictions]] <- 
      error_msg
}

#save the lists each time so we can review them and mess with them on another computer
save(list_of_fema_sitar_models_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_sitar_models_bmi.Rdata"))
save(list_of_fema_overall_fixed_effects_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_overall_fixed_effects_bmi.Rdata"))
save(list_of_fema_random_effects_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_random_effects_bmi.Rdata"))
save(list_of_fema_patient_data_with_sitar_predictions_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_patient_data_with_sitar_predictions_bmi.Rdata"))
save(list_of_fema_individual_patient_random_effects_for_curves_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_individual_patient_random_effects_for_curves_bmi.Rdata"))
save(list_of_fema_fitting_results_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_fitting_results_bmi.Rdata"))
save(list_of_fema_error_messages_bmi,   
     file = paste0("ar_data_files_to_load/list_of_fema_error_messages_bmi.Rdata"))
...
****************************************************
plot the bmi fixed and random effects fits for the model and calculate fit statistics
****************************************************

```{r, plot the bmi fixed and random effects fits for the model and calculate fit statistics}
#create three separate csv files to add results to
fit_statistics_of_both_sexes_models_bmi <- data.frame()
fit_statistics_of_male_models_bmi <- data.frame()
fit_statistics_of_fema_models_bmi <- data.frame()
...
list_of_combinations <- names(list_of_both_sexes_sitar_models_bmi)
#change that list by sex
if (grepl(x=lists_to_loop_around, pattern="male")){
  list_of_combinations <- names(list_of_male_sitar_models_bmi)
}    
if (grepl(x=lists_to_loop_around, pattern="fema")){
  list_of_combinations <- names(list_of_fema_sitar_models_bmi)
}    
...
underlying_sitar_model <- (list_of_both_sexes_sitar_models_bmi[[name_of_data]])
fixed_effects_to_plot <- (list_of_both_sexes_overall_fixed_effects_bmi[[name_of_data]])
random_effects_to_plot <- (list_of_both_sexes_individual_patient_random_effects_for_curves_bmi[[name_of_data]])

if (grepl(x=lists_to_loop_around, pattern="male")){
  underlying_sitar_model <- (list_of_male_sitar_models_bmi[[name_of_data]])
  fixed_effects_to_plot <- (list_of_male_overall_fixed_effects_bmi[[name_of_data]])
  random_effects_to_plot <- (list_of_male_individual_patient_random_effects_for_curves_bmi[[name_of_data]])
}

if (grepl(x=lists_to_loop_around, pattern="fema")){
  underlying_sitar_model <- (list_of_fema_sitar_models_bmi[[name_of_data]])
  fixed_effects_to_plot <- (list_of_fema_overall_fixed_effects_bmi[[name_of_data]])
  random_effects_to_plot <- (list_of_fema_individual_patient_random_effects_for_curves_bmi[[name_of_data]])
}
...
point_colour_by_sex <-
  "black"
vertical_line_colour_by_sex <-
  "black"
ar_data_points_to_plot_for_bmi <-
  ar_data_both_sexes_with_bmi_using_interpolations

#change our colours and data points for male
...
#change our colours and data points for female
...
#calculate our fixed effects adiposity peak and rebound frame
if (is.null(fixed_effects_to_plot)) next #
fixed_effects_adiposity_metrics_to_plot <-
  find_first_peak_trough(
      df=fixed_effects_to_plot,
      value_col="bmi",
      age_col="age"
  )
#extract the exact ages ensuring they are numbers
adiposity_peak_intercept <-
  fixed_effects_adiposity_metrics_to_plot$adiposity_peak_age

adiposity_rebound_intercept <-
  fixed_effects_adiposity_metrics_to_plot$adiposity_rebound_age

#correct for NA by making them zero if they are NA
if (is.na(adiposity_peak_intercept)){
  adiposity_peak_intercept <- 0
}
if (is.na(adiposity_rebound_intercept)){
  adiposity_rebound_intercept <- 0
}

number_of_patients <-
  length(unique(random_effects_to_plot$id))

plot_fixed_and_random_sitar_effect_fits_bmi <-
  ggplot() +
#plot the actual data points in the background
  geom_point(
    data=subset(ar_data_points_to_plot_for_bmi, age_to_use>=min_age & age_to_use<=max_age),
    aes(
      x=age_to_use,
      y=bmi_using_interpolations
    ),
...
#plot random effects
  geom_line(
    data=subset(random_effects_to_plot, age>=min_age & age<=max_age),
    aes(x=age, 
...
#plot fixed effects
  geom_line(
    data=subset(fixed_effects_to_plot, age>=min_age & age<=max_age),
    aes(x=age, 
        y=bmi), 
    linewidth=2, 
    linetype="longdash",
  ...
  labs(
    ...
    subtitle= 
      paste0("Number of patients = ", 
             ...
             "; Adiposity peak = ",
             round(
               adiposity_peak_intercept, digits=1),
             " years; Adiposity rebound = ",
             round(
               adiposity_rebound_intercept, digits=1),
             " years"),
    y="BMI (kg/m²)",
    x="Age (years)") +
#  geom_vline(
#    xintercept=adiposity_peak_intercept,
#    linetype="longdash",
#    linewidth=2,
#     colour=point_colour_by_sex
#  ) +
  geom_vline(
    xintercept=adiposity_rebound_intercept,
    linetype="dotdash",
    alpha=0.5,
    linewidth=2,
    colour=vertical_line_colour_by_sex
  ) +
  coord_cartesian(
    xlim=c(0,7),
    ylim=c(10,25)) +
...
dir.create(
  paste0("plot_fixed_and_random_sitar_effect_fits_bmi_",
...
# Save the plot as a png file
  ggsave(filename = 
           paste0("SITAR_fit_", 
                  name_of_data,
                  ".png"),
         path = paste0("plot_fixed_and_random_sitar_effect_fits_bmi_",
         lists_to_loop_around),
         plot = plot_fixed_and_random_sitar_effect_fits_bmi,
         device = "png",
         width = 6,
         height = 3,
         limitsize = FALSE)
# Save the plot again as a png file with blank axes
  ggsave(filename = 
           paste0("SITAR_fit_", 
                  name_of_data,
                  "_blank.png"),
...
if (lists_to_loop_around=="both_sexes"){
  fit_statistics_of_both_sexes_models_bmi <-
    rbind(fit_statistics_of_both_sexes_models_bmi, fit_statistics_of_model)
  write.csv(
    fit_statistics_of_both_sexes_models_bmi,
    "fit_statistics_of_both_sexes_models_bmi.csv",
    row.names=F
  )
}
#if we are doing male we add it to the male csv file  
if (lists_to_loop_around=="male"){
  fit_statistics_of_male_models_bmi <-
    rbind(fit_statistics_of_male_models_bmi, fit_statistics_of_model)
  write.csv(
    fit_statistics_of_male_models_bmi,
    "fit_statistics_of_male_models_bmi.csv",
    row.names=F
  )
}
#if we are doing fema we add it to the fema csv file  
if (lists_to_loop_around=="fema"){
  fit_statistics_of_fema_models_bmi <-
    rbind(fit_statistics_of_fema_models_bmi, fit_statistics_of_model)
  write.csv(
    fit_statistics_of_fema_models_bmi,
    "fit_statistics_of_fema_models_bmi.csv",
    row.names=F
  )
...
all_male_fit_statistics_bmi <- data.frame()

for (each_model in names(list_of_male_sitar_models_bmi)){

model <- list_of_male_sitar_models_bmi[[each_model]]
...
all_male_fit_statistics_bmi <- rbind(all_male_fit_statistics_bmi, fit_statistics)
write.csv(all_male_fit_statistics_bmi, "all_male_fit_statistics_bmi.csv", row.names=F)

}

all_fema_fit_statistics_bmi <- data.frame()

for (each_model in names(list_of_fema_sitar_models_bmi)){

model <- list_of_fema_sitar_models_bmi[[each_model]]
...
all_fema_fit_statistics_bmi <- rbind(all_fema_fit_statistics_bmi, fit_statistics)
write.csv(all_fema_fit_statistics_bmi, "all_fema_fit_statistics_bmi.csv", row.names=F)

}

all_both_sexes_fit_statistics_bmi <- data.frame()

for (each_model in names(list_of_both_sexes_sitar_models_bmi)){

model <- list_of_both_sexes_sitar_models_bmi[[each_model]]
...
all_both_sexes_fit_statistics_bmi <- rbind(all_both_sexes_fit_statistics_bmi, fit_statistics)
write.csv(all_both_sexes_fit_statistics_bmi, "all_both_sexes_fit_statistics_bmi.csv", row.names=F)
}
