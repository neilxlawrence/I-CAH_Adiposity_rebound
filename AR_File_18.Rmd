...
load_ar_files_function(previous_file_name = "file_17",
...
for (id_to_impute in unique(ar_data$id)){
#for (id_to_impute in 2166){
#for (id_to_impute in 2090){
#for (id_to_impute in 1635){
#id_to_impute <- 996
#id_to_impute <- 1632 # this patient looks like they have a height outlier - but the model doesn't sink to it unfortunately, showing the limitations of this method
#id_to_impute <- 2166 # this patient looks like they have a height outlier 
...
new_data_with_weight_and_age <-
  data.frame(
    ...
    manually_corrected_weight = ar_data$manually_corrected_weight
  )
...
ar_data_with_gam_height_weight_age_interpolations <-
  left_join(
    ar_data, 
    new_data_with_weight_and_age, 
    by = (c(
...
ar_data_with_gam_height_weight_age_interpolations$gam_interpolated_height_using_age_weight <-
  ifelse(is.na(ar_data_with_gam_height_weight_age_interpolations$manually_corrected_height),
         ar_data_with_gam_height_weight_age_interpolations$interpolate_height_using_gam_with_age_weight,
         ar_data_with_gam_height_weight_age_interpolations$manually_corrected_height)

#subset out just this patient
id_data_with_gam_height_weight_age_interpolations <- 
  subset(ar_data_with_gam_height_weight_age_interpolations, 
         id==id_to_impute)
...
ar_data_with_gam_height_age_interpolations <-
  left_join(
    ar_data, 
    new_data_with_age, 
    by = (c(
...
ar_data_with_gam_height_age_interpolations$gam_interpolated_height_using_age <-
  ifelse(is.na(ar_data_with_gam_height_age_interpolations$manually_corrected_height),
         ar_data_with_gam_height_age_interpolations$interpolate_height_using_gam_with_age,
         ar_data_with_gam_height_age_interpolations$manually_corrected_height)

#subset out just this patient
id_data_with_gam_height_id_data_with_gam_height_age_interpolations_age_interpolations <- 
  subset(ar_data_with_gam_height_age_interpolations, 
         id==id_to_impute)
...
all_ids_without_enough_data_for_gam <-
  subset(
    data.frame(id=unique(ar_data$id)), 
...
all_ids_without_enough_data_for_spline_or_gam_height_interpolation_frame <-
  subset(data.frame(id=unique(ar_data$id)), 
...
ar_data_with_all_height_imputations_a <-
  left_join(
    ar_data, 
    all_linear_interpolated_height_age_data_to_join,
    by="id_visit_date"
...
ar_data_with_all_height_imputations_b <-
  left_join(
    ar_data_with_all_height_imputations_a, 
    all_spline_height_age_interpolations_to_join,
    by="id_visit_date"
...
ar_data_with_all_height_imputations_c <-
  left_join(
    ar_data_with_all_height_imputations_b, 
    all_gam_height_age_interpolations_to_join,
    by="id_visit_date"
...
ar_data_with_all_height_imputations_d <-
  left_join(
    ar_data_with_all_height_imputations_c, 
    all_gam_height_weight_age_interpolations_to_join,
    by="id_visit_date"
...
nrow(ar_data_with_all_height_imputations_d) - nrow(ar_data)
...
ar_data_with_all_height_imputations_d$gam_interpolated_height_using_age_weight_flag <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$gam_interpolated_height_using_age_weight_flag),
    0,
    ar_data_with_all_height_imputations_d$gam_interpolated_height_using_age_weight_flag
  )

ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age_weight <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age_weight),
    0,
    ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age_weight
  )

ar_data_with_all_height_imputations_d$height_gam_age_weight_iteration_outlier_was_flagged <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$height_gam_age_weight_iteration_outlier_was_flagged),
    0,
    ar_data_with_all_height_imputations_d$height_gam_age_weight_iteration_outlier_was_flagged
  )
#correct gam with just age
ar_data_with_all_height_imputations_d$gam_interpolated_height_using_age_flag <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$gam_interpolated_height_using_age_flag),
    0,
    ar_data_with_all_height_imputations_d$gam_interpolated_height_using_age_flag
  )

ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age),
    0,
    ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age
  )

ar_data_with_all_height_imputations_d$height_gam_age_iteration_outlier_was_flagged <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$height_gam_age_iteration_outlier_was_flagged),
    0,
    ar_data_with_all_height_imputations_d$height_gam_age_iteration_outlier_was_flagged
  )
#correct spline with just age
ar_data_with_all_height_imputations_d$spline_interpolated_height_flag <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$spline_interpolated_height_flag),
    0,
    ar_data_with_all_height_imputations_d$spline_interpolated_height_flag
  )

ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_spline_age <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_spline_age),
    0,
    ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_spline_age
  )

ar_data_with_all_height_imputations_d$height_spline_iteration_outlier_was_flagged <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$height_spline_iteration_outlier_was_flagged),
    0,
    ar_data_with_all_height_imputations_d$height_spline_iteration_outlier_was_flagged
  )

#correct linear interpolation flag, remember no outliers in this method
ar_data_with_all_height_imputations_d$linear_interpolated_height_flag <-
  ifelse(
    is.na(ar_data_with_all_height_imputations_d$linear_interpolated_height_flag),
    0,
    ar_data_with_all_height_imputations_d$linear_interpolated_height_flag
  )
#first, we check whether outliers can be flagged by more than one mehtod

ar_data_with_all_height_imputations_d$both_gam_outlier <-
  ifelse(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age_weight==1 & ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age==1,
         1,
         0)
...
sum(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age_weight)
print("Remaining number flagged by GAM height on age with no covariate:")
sum(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_gam_age) -
sum(ar_data_with_all_height_imputations_d$both_gam_outlier)
print("Remaining number flagged by smooth spline:")
sum(ar_data_with_all_height_imputations_d$manually_corrected_height_flagged_as_an_outlier_by_spline_age)
...
ar_data$interpolated_height <-
  ifelse(!is.na(ar_data$linear_interpolated_height),
         ar_data$linear_interpolated_height,
         NA)
#categorise the method we have used if we have used that
ar_data$interpolated_height_method <-
  ifelse(!is.na(ar_data$linear_interpolated_height),
...
ar_data$interpolated_height <-
  ifelse(!is.na(ar_data$spline_interpolated_height),
         ar_data$spline_interpolated_height,
         ar_data$interpolated_height)
#categorise the method we have used if we have used that
ar_data$interpolated_height_method <-
  ifelse(!is.na(ar_data$spline_interpolated_height),
...
ar_data$interpolated_height <-
  ifelse(!is.na(ar_data$gam_interpolated_height_using_age),
         ar_data$gam_interpolated_height_using_age,
         ar_data$interpolated_height)
#categorise the method we have used if we have used that
ar_data$interpolated_height_method <-
  ifelse(!is.na(ar_data$gam_interpolated_height_using_age),
...
ar_data$interpolated_height <-
  ifelse(!is.na(ar_data$gam_interpolated_height_using_age_weight),
         ar_data$gam_interpolated_height_using_age_weight,
         ar_data$interpolated_height)
#categorise the method we have used if we have used that
ar_data$interpolated_height_method <-
  ifelse(!is.na(ar_data$gam_interpolated_height_using_age_weight),
...
ar_data$interpolated_height <-
  ifelse(is.na(ar_data$interpolated_height),
...
ar_data$interpolated_height_method <-
  ifelse(!is.na(ar_data$manually_corrected_height_before_outlier_corrections) & 
           ar_data$manually_corrected_height_before_outlier_corrections==ar_data$interpolated_height,
         "original_measurement",
         ar_data$interpolated_height_method)

#then we can say that any remaining NA values we are unable to interpolate
ar_data$interpolated_height_method <-
  ifelse(is.na(ar_data$interpolated_height_method),
...
sum(is.na(ar_data$interpolated_height)) - sum(ar_data$interpolated_height_method=="unable_to_interpolate")
print("Summary statistics for height before outlier corrections:")
descr(ar_data$manually_corrected_height_before_outlier_corrections)
print("Summary statistics for height after outlier corrections:")
descr(ar_data$interpolated_height)
print("Number of readings before outlier corrections")
sum(!is.na(ar_data$manually_corrected_height_before_outlier_corrections))
print("Number of registered methods of interpolation")
sum(!is.na(ar_data$interpolated_height_method))
...
sum(!is.na(ar_data$manually_corrected_height_before_outlier_corrections)) - sum(!is.na(ar_data$interpolated_height_method))
print("The interpolation method frequencies are as follows:")
freq(ar_data$interpolated_height_method)
...
ar_data$interpolated_height_flag_because_missing <-
  ifelse(is.na(ar_data$manually_corrected_height_before_outlier_corrections) &
           !is.na(ar_data$interpolated_height),
         1,
         0)
#freq(ar_data$interpolated_height_flag_because_missing)

ar_data$interpolated_height_flag_because_outlier <-
  ifelse(!is.na(ar_data$manually_corrected_height_before_outlier_corrections) &
           ar_data$manually_corrected_height_before_outlier_corrections!=ar_data$interpolated_height,
         1,
         0)
#freq(ar_data$interpolated_height_flag_because_outlier)

print("we have interpolated the following number of heights because they were missing:")
sum(ar_data$interpolated_height_flag_because_missing)
...
sum(ar_data$interpolated_height_flag_because_outlier)
